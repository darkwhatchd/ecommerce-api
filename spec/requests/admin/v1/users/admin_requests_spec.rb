...
RSpec.describe "Admin::V1::Users as :admin", type: :request do
  ...
  context "GET /users" do
    ...
    it "returns all users" do
      get url, headers: auth_header(admin_user)
      users << admin_user
  ...
  context "POST /users" do
    ...
    context "with valid params" do
      ...
      it "adds a new user" do
        expect do
          post url, headers: auth_header(admin_user), params: user_params
    ...
    context "with invalid params" do
      ...
      it "does not add a new User" do
        expect do
          post url, headers: auth_header(admin_user), params: user_invalid_params
  ...
  context "PATCH /users/:id" do
    ...
    context "with valid params" do
      ...
      it "updates User" do
        patch url, headers: auth_header(admin_user), params: user_params
        user.reload
  ...
  context "DELETE /users/:id" do
    ...
    it "removes User" do
      expect do
        delete url, headers: auth_header(admin_user)
      end.to change(User, :count).by(-1)
    end
